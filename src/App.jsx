...
<div className="relative before:content-[''] pt- 4 pb-1 before:absolute before:inset-0 before:rounded-full before:z-0">
  <motion.img
    src="/chmunlogo.png"
    alt="CHMUN Logo"
    className="w-60 h-60 md:w-60 md:h-60 mt-3 md:mt-4.5 mb-[-0.2rem] mx-auto block relative z-10"
              ...
              >
                ...
                <motion.p className="text-2xl font-serif">
                  {closing.split("\n")[1]}
                                ...
                                <motion.p className="text-xl pt-2  font-serif">
                  {closing.split("\n")[2]}
                </motion.p>
                                <motion.p className="text-xl py-1 font-serif">
                  {closing.split("\n")[3]}
                </motion.p>
              </motion.div>
            </div>
