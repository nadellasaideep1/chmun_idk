    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <p className="text-2xl md:text-3xl text-gray-200 text-center mb-12">
          <strong>Agenda:</strong> Deliberating on the Right to Self Determination with special emphasis on the Donetsk and Luhansk People's Republic.
        </p>
        ...
        <div className="flex flex-row sm:flex-row mb-5 gap-4">
          <a
            href="https://docs.google.com/spreadsheets/d/17j3mgUWoVHAypN4l-MdZtOFcBEQA-5zGSE7GTeToyBI/edit?gid=1769957479#gid=1769957479"
            target="_blank"
          ...
          <a
            href="https://drive.google.com/file/d/1JSACHWBn7sVfFbQZYiFzbylxxrdFd4NY/view?usp=share_link"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button
